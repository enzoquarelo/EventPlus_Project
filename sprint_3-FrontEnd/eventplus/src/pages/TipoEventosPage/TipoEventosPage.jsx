...
const TipoEventosPage = () => {
  ...
  async function loadEventTypes() {
    ...
    try {
      ...
      notifyError(
        "Houve um error no carregamento de informações. Verifique a sua conexão com a internet!"
      );
    }
  ...
  async function handleDelete(idElement) {
    ...
    try {
      ...
      setTipoEventos(
        tipoEventos.filter((type) => type.idTipoEvento !== idElement)
      );
      notifySuccess("Evento excluído com sucesso");
      // setEventTypes([]);
    } catch (error) {
      notifyError(
        "Houve um error ao remover um tipo de evento. Verifique a sua conexão com a internet!"
      );
    }
          ...
          <Container>
            <div className="cadastro-evento__box">
              ...
              <form
                ...
                onSubmit={setFrmEdit ? handleUpdate : handleSubmit}
              >
                {!frmEdit ? (
                  <>
                    <Input
